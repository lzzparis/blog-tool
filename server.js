...
app.post("/prepop", function(req, res){
  var prePopData = [
    { subject: "Blog post 1", 
      ...
      timestamp: (new Date()).setFullYear(2110,2,14)
    },
    { 
      ...
      body: "Holding her is dangerous", 
      timestamp: (new Date()).setFullYear(110,1,24)
    },
    { 
      subject: "Trapped", 
      ...
      body: "Perhaps you refer to the imminent attack of your Rebel fleet.", 
      timestamp: (new Date()).setFullYear(1690,7,13)
    },
    {
      subject: "Alderaan", 
      ...
      body: "We've entered the Alderaan system.", 
      timestamp: (new Date()).setFullYear(4110,11,16)
    },
  ];
