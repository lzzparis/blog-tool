...
describe('App name', function(){
  ...
  //     Post.create({subject: "Blog post 1", body: "Here are some words", timestamp: "Sun Oct 09 2016 22:18:20 GMT-0700 (MST)"},
  ...
  it("should populate the database on prepop POST route", function(done){
    ...
    .end(function(err,res){
      ...
      res.body[0].subject.should.equal("Blog post 1");
      res.body[1].subject.should.equal("Red and gold");
      res.body[2].subject.should.equal("Trapped");
      res.body[3].subject.should.equal("Alderaan");
      done();
    });
  });
